...
const Contact = () => {
  ...
  const [state, handleSubmit] = useForm("mpzgbojb");
    ...
    <section className=" sm:px-8 pt-[80px]" id="contact">
      ...
      <div className="grid md:grid-cols-2 mt-4 md:mt-10 py-12 gap-4 relative">
        ...
        >
          ...
          <p className="text-textWhite max-w-md">
            ...
            <br />
            <br />
            Phone Number: 0905 768 751
            <br />
            Address: 390 Ton Dan, Hoa An, Cam Le, Da Nang
            <br />
            Email: trandangkhoa5495@gmail.com
          </p>
          <div className="flex flex-row gap-5 mt-6">
            <a
              href="https://github.com/trandangkhoa5495"
            ...
            <a
              href="https://www.facebook.com/profile.php?id=100009139431096"
              className="relative group hover:-translate-y-[2px] transition-all duration-500 ease-in-out "
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <footer className="flex items-center p-6 text-center">
        <span className="w-full text-textPara">
          All Rights Reserved © {new Date().getFullYear()} - Khoa Tran
        </span>
      </footer>
    </section>
  );
