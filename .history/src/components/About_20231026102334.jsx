      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 py-6 place-items-center">
        ...
        >
          <p className="text-textWhite p-4 text-lg sm:text-xl sm:leading-8">
            I am a passionate MERN Stack Developer and Problem Solver, dedicated
            to creating impactful codes that thrive on the internet.
            <br />
            I have experience working with JavaScript, HTML, CSS, React.js,
            Node.js, Express.js, MySQL and Git.
